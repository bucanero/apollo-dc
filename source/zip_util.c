...
/*
extern const uint8_t binary_data_inside_ahx_start;
extern const uint8_t binary_data_inside_ahx_size;

int main(int argc, char* argv[])
{
	const void* abc = &binary_data_inside_ahx_start;
	int x = (int)&binary_data_inside_ahx_size;
	printf ("%d abc = %p\n", x, abc);
 return 0;
}
*/